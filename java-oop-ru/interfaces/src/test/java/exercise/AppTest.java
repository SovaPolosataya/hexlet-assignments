...
class AppTest {
    ...
    void testSubSequence() {
        ...
        String textReverse = "gfedcba";
        char textCharAt = 'c';
        int testLength = 7;
        String testSubSequence = "fedc";

        assertThat(textReverse).isEqualTo(text.toString());
        assertThat(textCharAt).isEqualTo(text.charAt(4));
        assertThat(testLength).isEqualTo(text.length());
        assertThat(testSubSequence).isEqualTo(text.subSequence(1, 5));
    }
    // END
}
